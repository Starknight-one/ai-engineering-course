...
- `ADW/*.py` contain Python automation scripts. Run them with `python <script_name>`.
...
- `app/backend/**` - Contains the Express + TypeScript backend API server.
- `app/start.sh` - Script to start frontend and backend servers.
- `app/stop.sh` - Script to stop frontend and backend servers.
- `ADW/**` - Contains Python automation scripts for Claude Code workflows.
